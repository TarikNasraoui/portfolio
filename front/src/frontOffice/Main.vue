  ...
  <div id="colorlib-main">
    <section id="colorlib-hero" class="js-fullheight" data-section="home">
      <div class="flexslider js-fullheight">
        <ul class="slides">
          <li :style="{ backgroundImage: `url(${backgroundUrl})` }">
          ...
          <li :style="{ backgroundImage: `url(${backgroundUrl2})` }">
            <div class="overlay"></div>
            <div class="container-fluid">
              <div class="row">
                <div
                ...
                <div class="panel panel-default">
                  <div class="panel-heading" role="tab" id="headingOne">
                    <h4 class="panel-title">
                      ...
                      >Master Degree Graphic Design</a>
                    </h4>
                  </div>
                  <div
                    id="collapseOne"
                ...
                <div class="panel panel-default">
                  <div class="panel-heading" role="tab" id="headingTwo">
                    <h4 class="panel-title">
                      ...
                      >Bachelor Degree of Computer Science</a>
                    </h4>
                  </div>
                  <div
                    id="collapseTwo"
                ...
                <div class="panel panel-default">
                  <div class="panel-heading" role="tab" id="headingThree">
                    <h4 class="panel-title">
                      ...
                      >Diploma in Information Technology</a>
                    </h4>
                  </div>
                  <div
                    id="collapseThree"
                ...
                <div class="panel panel-default">
                  <div class="panel-heading" role="tab" id="headingFive">
                    <h4 class="panel-title">
                      ...
                      >High School Secondary Education</a>
                    </h4>
                  </div>
                  <div
                    id="collapseFive"
...
<script>
import backgroundUrl from '../assets/images/img_bg_1.jpg'
import backgroundUrl2 from '../assets/images/img_bg_2.jpg'
